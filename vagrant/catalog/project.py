...
def showCategories():
    ...
    # Ensure that items are ordered in descending order to only
    # show latest items on the front page
    ...
    return render_template('categories.html', categories=categories, items=items, permissions=permissions)
...
def editCategory(category_id):
    ...
    if request.method == 'POST':
        ...
        if request.form['image']:
            ...
            flash('Category Successfully Edited %s' % editedCategory.image)
...
def newCategoryItem(category_id):
    ...
    if request.method == 'POST':
        newItem = CategoryItem(name=request.form['name'], description=request.form['description'], category_id=category_id, user_id=category.user_id, image=request.form['image'])
        session.add(newItem)
        session.commit()
